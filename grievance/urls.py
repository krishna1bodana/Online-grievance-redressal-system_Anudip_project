...
urlpatterns = [
    ...
    path(
        'grievance/<int:grievance_id>/',
        views.grievance_detail,
        name='grievance_detail'
    ),

    path(
        'feedback/<int:grievance_id>/',
        views.submit_feedback,
        name='submit_feedback'
    ),

    path(
        'attachment/<int:grievance_id>/',
    ...
    # =========================
    path(
        'api/grievance-status/<int:grievance_id>/',
        views.grievance_status_api,
        name='grievance_status_api'
    ),
    ...
    path(
        'officer/update-status/<int:grievance_id>/',
        views.officer_update_status,
        name='officer_update_status'
    ),
    # =========================
# NOTIFICATIONS
# =========================
