...
# 🔁 Role-based redirect (officer → dashboard, user → home)
...
# Prints emails to terminal (safe for development)
...
# ESCALATION CONFIG
# =========================
ADMIN_EMAIL = 'bodanakrishna38@gmai.com'  # change to real email
